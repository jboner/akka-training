...
Tests to verify exercises are located in "src/test/scala/builtin"
Solutions to the exercises are located in "src/test/scala/key"

The labs are test-driven. 
...
---------------------
  ...
  - Download and install SBT 0.7.4. Follow instructions on: http://code.google.com/p/simple-build-tool/wiki/Setup
...
--------------------
  ...
  - Download Akka Training distribution from: TODO
